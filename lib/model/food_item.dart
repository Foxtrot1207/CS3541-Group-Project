...
class FoodItem {
  ...
  FoodItem({required this.name, required this.servingSize, required this.calories, required this.macros, required this.ozWater, required this.caffeine /*required this.sugar*/});
