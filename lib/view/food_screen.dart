                    ...
                    ElevatedButton(
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          widget.controller.createFoodItem(FoodItem(name: _name, calories: _calories, fat_g: _fat, protein_g: _protein, carbohydrates_g: _carbohydrates, servingSize: _servingSize, sugar_g: _sugar, caffeine_mg: _caffeine, water_ml: _water));
